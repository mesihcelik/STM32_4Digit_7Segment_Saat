...
#include "analog_buttons_drivers.h"
...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  PC5_Button_Driver_init();
  PC6_Button_Driver_init();
  PC8_Button_Driver_init();
  PC9_Button_Driver_init();
  PA11_Button_Driver_init();
  PC13_Button_Driver_init();
  buzzerdriver_init();
